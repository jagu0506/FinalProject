...
const Register = ()=>{
  ...
  <div className="row">
    <div className="col-sm-8 mx-auto text-center" style={{boxShadow: '0 0 2px 1px white'}}>
      <div className="card shadow" style={{marginTop: 50}}>
        <div className="card-body">
          <img src="/images/logo.png" style={{width: 150}} className="my-2 rounded-circle" />
...
required placeholder="Email Id or User ID" name="userid" value={user.userid} onChange={handleInput} className="form-control" />
                  </div>
                </div>
                <div className="form-group">
                  <div className="input-group">
                    ...
                    <input type="password" placeholder="Eg.Jagruti@123" className="form-control" pattern="((?=.*\\d)(?=.*[a-z])(?=.*[#@$*]).{5,20})" required name="pwd" value={user.pwd} onChange={handleInput}/>
                  </div>
                </div>
                <div className="form-group">
                  <div className="input-group">
                    ...
                    <input type="password" pattern="((?=.*\\d)(?=.*[a-z])(?=.*[#@$*]).{5,20})"
required name="cpwd" value={user.cpwd} onChange={handleInput}  placeholder="Repeat Password" className="form-control" />
                  </div>
                </div>
              </div>
              <div className="col-sm-6">
            ...
            <input type="submit" defaultValue="Register" className="btn btn-success btn-block" />
          </form>
        </div>
      </div>
    </div>
